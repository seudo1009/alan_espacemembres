...
die('Erreur : ' . $e->getMessage());
	  ...
	  ON publications.id_post = post_support.id_poster WHERE publications.id_membre = '.$_SESSION['id_m'].' ORDER BY publications.id_post DESC LIMIT '.$_SESSION['pageb'].' ,10');
  ...
  $req->execute(array(htmlspecialchars($_SESSION['id_m'])));
